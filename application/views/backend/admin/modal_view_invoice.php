    ...
    <div id="invoice_print">
        ...
        <table width="100%" border="0">    
            <tr>
                ...
                <td align="right">KES <?php echo number_format($row['amount'], 2); ?></td>
            </tr>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Paid Amount'); ?> :</h4></td>
                <td align="right"><h4>KES <?php echo number_format($row['amount_paid'], 2); ?></h4></td>
            </tr>
            <?php if ($row['due'] != 0):?>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Due'); ?> :</h4></td>
                <td align="right"><h4>KES <?php echo number_format($row['due'], 2); ?></h4></td>
            </tr>
            <?php endif;?>
        </table>
