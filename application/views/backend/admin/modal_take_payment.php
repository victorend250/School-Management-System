                ...
                <table class="table table-bordered table-hover table-striped">
                	...
                	?>
                		<tr>
                			...
                			<td>KES <?php echo number_format($row2['amount'], 2);?></td>
                			<td>
                				<?php 
                					if ($row2['method'] == 1)
                						echo ('Cash');
            ...
            <div class="panel-body">
				<?php echo form_open(base_url() . 'index.php?admin/invoice/take_payment/'.$row['invoice_id'], array(
					...
					<div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" value="KES <?php echo number_format($row['amount'], 2);?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" name="amount_paid" value="KES <?php echo number_format($row['amount_paid'], 2);?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" value="KES <?php echo number_format($row['due'], 2);?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="method" class="form-control">
                                ...
                                <option value="4"><?php echo ('MPesa');?></option>
                                <option value="5"><?php echo ('Bank Transfer');?></option>
                            </select>
                        </div>
                    </div>
